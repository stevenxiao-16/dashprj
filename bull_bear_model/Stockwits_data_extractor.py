# -*- coding: utf-8 -*-
"""
Created on Tue Sep 15 15:24:15 2020
...
FIELDS = ['symbol', 'sentiment','message', 'datetime', 'message_id',]
#SYMBOL = "AAPL" #Apple
#SYMBOL = "WMT" #Walmart
#SYMBOL = "TSLA" #Tesla
#SYMBOL = "BMW" #BMW
#SYMBOL = "GOOS" #Canada Goose (Consumer Disc sector)
#SYMBOL = "TD" #TD bank
#SYMBOL = "ENB" #Enbridge (Energy Sector)
#SYMBOL = "SHOP" #Shopify
#SYMBOL = "BYD" #Boyd Group (Automotive glass, industrials sector)
SYMBOL = "KL" #Kirkland Lake (Material Sector, gold miner)
FILE_NAME = './train_data/stocktwits_' + SYMBOL + '.csv'
token = 0
